...
PYTHONPATH=src python3 main.py calibration --data-mode market --curve-csv data/european/market/curve_points.csv --spec-csv data/european/market/swaption_spec.csv --vol-slice-csv data/european/market/vol_slice.csv

PYTHONPATH=src python3 main.py pricing --data-mode market --bootstrap-curve --market-quotes-csv data/european/market/market_quotes.csv --spec-csv data/european/market/swaption_spec.csv

PYTHONPATH=src python3 main.py sofr --sofr-csv data/common/market/sofr/sofr_history.csv --sofr-quote-csv data/processed/sofr_latest_quote.csv
